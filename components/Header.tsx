    ...
    <header className="flex items-center justify-between px-4 py-4 max-w-5xl mx-auto w-full">
      {onTitleClick ? (
        <button
          ...
          className="text-3xl font-serif text-[#3b2a1a] tracking-tight hover:opacity-80 transition-opacity"
        >
          Jeff&rsquo;s<span className="text-[#b5763a]">BookMatch</span>
        </button>
      ) : (
        <Link href="/" className="text-3xl font-serif text-[#3b2a1a] tracking-tight hover:opacity-80 transition-opacity">
          Jeff&rsquo;s<span className="text-[#b5763a]">BookMatch</span>
        </Link>
      )}
      <Link
